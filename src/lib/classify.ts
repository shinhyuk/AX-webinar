...
2) score: 질문이면 1~100으로 채점하라. 핵심 기준은 "AX(AI 전환) 관점에서 얼마나 퀄리티 높고 심오한 질문인가"이다:
   - AI 전환의 본질(전략, 조직 변화, 일하는 방식의 재정의)을 꿰뚫는 통찰의 깊이
   - 단순 기능 문의가 아닌, 도입·확산·리스크·성과측정 등 실행 관점의 구체성
   - 발표자와 다른 청중의 사고를 확장시키는 가치
   90~100: AX의 본질을 찌르는 탁월하고 심오한 질문 / 70~89: 깊이 있는 좋은 질문 / 40~69: 무난한 질문 / 1~39: 피상적·단순 문의
   질문이 아니면 score는 0.
